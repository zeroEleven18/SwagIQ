    ...
    <div className="space-y-6 max-w-7xl mx-auto pb-12">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3.5">
        <div className="bg-slate-900/90 border border-slate-800 rounded-2xl p-4 shadow-xl">
          ...
          <div className="text-[10px] text-slate-500 mt-1">Offense & Defense Schemes</div>
        </div>
        ...
        <div className="bg-slate-900/90 border border-slate-800 rounded-2xl p-4 shadow-xl">
          ...
          <div className="text-[10px] text-emerald-400 mt-1">Tracking Live Game Flow</div>
        </div>

        <div className="bg-slate-900/90 border border-slate-800 rounded-2xl p-4 shadow-xl">
          <div className="text-[11px] text-slate-400 font-semibold mb-1 uppercase tracking-wider">{t.complianceRateCard}</div>
          <div className="text-2xl font-bold font-mono text-emerald-400">{avgCompliance}%</div>
          <div className="text-[10px] text-slate-400 mt-1">Coach Directives Adherence</div>
        </div>
        ...
        <div className="bg-slate-900/90 border border-slate-800 rounded-2xl p-4 shadow-xl">
          ...
          <div className="text-[10px] text-slate-400 mt-1">Avg 1.32 Points Per Possession</div>
        </div>
      </div>
                  ...
                  <div className="flex items-start justify-between gap-2">
                    ...
                    <div className="text-right">
                      <span className={`text-xs font-mono font-bold block ${
                        isGoodCompliance ? 'text-emerald-400' : 'text-amber-400'
                      }`}>
                        {play.complianceRate}%
                      </span>
