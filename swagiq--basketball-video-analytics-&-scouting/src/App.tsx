    ...
    <div className="flex h-screen w-full bg-[#020617] text-slate-200 font-sans overflow-hidden">
      ...
      <div className="flex-1 flex flex-col h-full bg-[#020617] overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-6">
          ...
          {activeTab === 'shotchart' && currentGame && (
          ...
          {activeTab === 'boxscore' && currentGame && (
            <BoxScoreStats game={currentGame} />
          )}

          {/* Tab: Tactical Analysis & SAM 3 */}
          {activeTab === 'tactics' && currentGame && (
            <TacticalAnalysis
              game={currentGame}
          ...
          {activeTab === 'highlights' && currentGame && (
            <HighlightsGenerator
              game={currentGame}
